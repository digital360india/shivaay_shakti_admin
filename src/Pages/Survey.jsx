...
const Survey = () => {
  ...
  async function handleDelete(id)
  {
    console.log(id);
    try{
     const res=await axios.delete(`https://shivaay-shakti-backend-1.onrender.com/api/survey/${id}`,{
      headers:{
  ...
  {
    try{
      const res=await axios.get("https://shivaay-shakti-backend-1.onrender.com/api/survey",{
        headers:{
          Authorization:localStorage.getItem('jwt')
        }
      });
