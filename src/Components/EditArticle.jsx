...
let i=1;
function EditArticle({toggle2,setToggle2,value,setToggle}) {
   console.log(value);
          ...
          if(data.articleimg!=="")
            {
              ...
              delete data.message;
              delete data.image1;
         const response=await axios.put(`https://shivaay-shakti-backend-vm3k.onrender.com/api/article/${value._id}`,data,{
            headers:{
